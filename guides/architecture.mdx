...
<AccordionGroup>
  <Accordion title="AppModule" icon="cube">
    ...
    - SupabaseModule — Database and storage connections
    - BullModule — Redis-based job queue connection
    ...
    - LoggerModule — Structured logging with pino
    - TasksModule — Scheduled tasks and polling
